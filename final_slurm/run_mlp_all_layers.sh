...
#SBATCH --job-name=mlp_all_layers # Updated job name
...
accelerate launch --num_processes=2 --num_machines=1 --mixed_precision=bf16 train_mistral_lora_accelerate.py --config final_configs/config_mlp_all_layers.yaml # Updated config path
